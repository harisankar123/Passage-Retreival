...
public class BatchSearch {
	...
	public static void main(String[] args) throws Exception {
		...
		//String queries = "test-data/title-queries.301-450";
		String queries = "Training/queries";
		...
		while (true) {
			...
			//System.out.println("here "+pair[1]);
	...
	public static void doBatchSearch(BufferedReader in, IndexSearcher searcher, String qid, Query query, String runtag)	 
		...
		HashMap<String, String> seen = new HashMap<String, String>(100);
		...
		for (int i = start; i < end; i++) {
			...
			System.out.println(qid+" 0 "+docno+" "+i+" "+hits[i].score+" "+runtag);
		}
	}
}
